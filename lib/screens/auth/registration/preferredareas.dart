...
class PreferredaAreas extends StatefulWidget {
  const PreferredaAreas({Key? key}) : super(key: key);

  @override
  _PreferredaAreasState createState() => _PreferredaAreasState();
}

class _PreferredaAreasState extends State<PreferredaAreas> {
